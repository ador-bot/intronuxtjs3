<template>
    <div class="flex flex-col py-10">
        ...
        <div class="flex justify-center items-center h-32">
            <input class="px-2 py-1 border border-gray-800 rounded-md min-w-64" v-model="searchTerm" type="text"
                placeholder="Search ...">
        </div>
        ...
        <div class="flex justify-center">
            <button v-if="!disabledPrevious" @click="page--" class="px-4 py-2 text-m border rounded-lg">Prev</button>
...
const debouncedSearchTerm = refDebounced(searchTerm, 700) //wait 7 seconds
